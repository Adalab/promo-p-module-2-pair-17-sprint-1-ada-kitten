...
const description2 =
  "Ruiseño, juguetón, le guta estar tranquilo cariñoso y que nadie le moleste. Es una maravilla acariciarle!";
...
input.value = "cariñoso";
const inputValue = input.value;
//
if (description1.includes(inputValue)) {
  list.innerHTML = list.innerHTML + content1;
}
if (description2.includes(inputValue)) {
  list.innerHTML = list.innerHTML + content2;
}
if (description3.includes(inputValue)) {
  list.innerHTML = list.innerHTML + content3;
}
